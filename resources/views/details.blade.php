                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        <div>
                                            <img src="{{asset('uploads/products')}}/{{$product->image}}" id="zoom_01"
                                                data-zoom-image="{{asset('uploads/products')}}/{{$gimg}}"
                                                class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="">
                                        </div>
                                        <div>
                                            <img src="{{asset('uploads/products')}}/{{$gimg}}" id="zoom_02"
                                                data-zoom-image="{{asset('uploads/products')}}/{{$gimg}}"
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    ...
                                    <h3 class="theme-color"> @if($product->sale_price)
                                        <s>${{$product->regular_price}}</s> ${{$product->sale_price}}
                                        @else
                                        {{$product->regular_price}}
                                        @endif
                    ...
                    <!-- <div>
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}" class="font-default">
                                        <h5 class="ms-0">{{$rproduct->name}}</h5>
                                    </a>
                                    <div class="listing-content">
