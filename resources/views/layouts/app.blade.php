...
<head>
    ...
    <title>{{ config('app.name', 'wmart') }}</title>
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('home.index')}}" class="nav-link menu-title">Home</a></li>
                                    ...
                                    <li class="onhover-dropdown">
                                        ...
                                        <div class="onhover-div profile-dropdown">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{ Auth::user()->utype === 'ADM' ? route('admin.index'): route('user.index') }}" class="d-block">Login
                ...
                <div class="row gy-4">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="{{route('home.index')}}" class="footer-logo float-start">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +91 8245808459</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Samlong, Ranchi, Jharkhand,
                                            India</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@wmart.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="{{route('home.index')}}" class="font-dark">Home</a>
                                    </li>
                                    <li>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, wmart.</p>
                    </div>
                </div>
            </div>
        </div>
