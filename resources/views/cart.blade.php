                        ...
                        <tr>
                            <td>
                                <a href="../product/details.html">
                                    <img src="{{asset('uploads/products/thumbnails')}}/{{$item->model->image}}" class="blur-up lazyloaded"
                                        alt="{{$item->name}}">
                                </a>
                            </td>
                            <td>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center pt-5 bp-5">
                ...
                <a href="{{route('shop.index')}}" class="btn" style="background-color: #e87316;">Shop Now</a>
            </div>
        </div>
    </div>
@endif
